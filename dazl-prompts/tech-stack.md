...
React 19, TypeScript, npm, Node.js, CSS Modules, **React Router v7 only** (do not use any other versions), React Hook Form, Radix-UI, Tabler Icons.
...
- Import icons from `@tabler/icons-react` package.
